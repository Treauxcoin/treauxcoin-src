...
QString BitcoinUnits::description(int unit)
{
    switch(unit)
    {
    case BTC: return QString(QObject::tr("TREAUXCOINs"));
    case mBTC: return QString(QObject::tr("Milli-TREAUXCOINs (1 / 1,000)"));
    case uBTC: return QString(QObject::tr("Micro-TREAUXCOINs (1 / 1,000,000)"));
    default: return QString("???");
    }
}
