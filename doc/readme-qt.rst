TREAUXCOIN-qt: Qt4 GUI for TREAUXCOIN
===============================
...
Alternatively, install Qt Creator and open the `TREAUXCOIN-qt.pro` file.

An executable named `TREAUXCOIN-qt` will be built.
...
A warning for people using the *static binary* version of TREAUXCOIN on a Linux/UNIX-ish system (tl;dr: **Berkely DB databases are not forward compatible**).

The static binary version of TREAUXCOIN is linked against libdb5.3.
...
installed causes TREAUXCOIN-qt to crash intermittently.  The issue has been reported as `launchpad bug 857790`_, but
isn't yet fixed.
